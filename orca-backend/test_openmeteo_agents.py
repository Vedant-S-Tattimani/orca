#!/usr/bin/env python3
"""
Test script for the Open-Meteo agents
"""
import asyncio
import sys
...
async def test_agents():
    ...
    try:
        ...
        print(f"Marine Agent Result: {marine_result}")

        # Check if we got reasonable data
        if "error" not in weather_result and "error" not in marine_result:
            print("\n✅ Both agents returned data successfully!")
            ...
            print("\n❌ One or both agents returned errors:")
